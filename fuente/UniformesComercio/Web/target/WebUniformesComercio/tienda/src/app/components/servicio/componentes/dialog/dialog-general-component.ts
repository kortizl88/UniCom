...
export class DialogGeneralComponent {
    ...
    public iniciarEspera(): MdDialogRef<DialogSicronoComponent> {
       let dialogRefSicrono = this.dialog.open(DialogSicronoComponent, { disableClose: true, panelClass: 'dialog-sincrono-transparente' });
      // var d = document.getElementById('id-dialog-sincrono');
      // d.parentElement.parentElement.parentElement.className = 'dialog-sincrono-transparente';
