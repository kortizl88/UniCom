...
public interface ValidaSesionSoap {
    ...
    @RequestWrapper(localName = "RecibePeticion", targetNamespace = "http://tempuri.org/", className = "com.elektra.agendaWeb.seguridad.RecibePeticion")
    @ResponseWrapper(localName = "RecibePeticionResponse", targetNamespace = "http://tempuri.org/", className = "com.elektra.agendaWeb.seguridad.RecibePeticionResponse")
