...
(	FIFOLIOSOLICITUD NUMBER (20) NOT NULL,
	...
	CONSTRAINT PK_TASOLICITUDESDETALLE PRIMARY KEY (FIFOLIOSOLICITUD, FIIDDETALLE),
...
CREATE TABLE UNIFORMES.TABITACORASOLICITUD
	...
	CONSTRAINT FK_TABITACORASOLICITUD_01 FOREIGN KEY (FIFOLIOSOLICITUD,FIIDDETALLE) REFERENCES UNIFORMES.TASOLICITUDESDETALLE (FIFOLIOSOLICITUD,FIIDDETALLE),
	CONSTRAINT FK_TABITACORASOLICITUD_02 FOREIGN KEY (FIESTATUSANT) REFERENCES UNIFORMES.TAESTATUSPEDIDOS (FIIDESTATUSPEDIDO),
	CONSTRAINT FK_TABITACORASOLICITUD_03 FOREIGN KEY (FIESTATUSNVO) REFERENCES UNIFORMES.TAESTATUSPEDIDOS (FIIDESTATUSPEDIDO),
	CONSTRAINT FK_TABITACORASOLICITUD_04 FOREIGN KEY (FIIDERROR) REFERENCES UNIFORMES.TATIPOSERROR (FIIDERROR)
	)
	LOGGING
	TABLESPACE TBS_UNIFORMES_OPE_DAT;
